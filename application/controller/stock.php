    ...
    public function approvisionnerproduit($id_produit='')
    {
        ...
        {         
            ...
            //{
                ...
                { 
                    for($compteur = 0 ; $compteur<count($_POST['depot_choisi']) ; $compteur++)
                    {
                        $arg = array('id_produit' => $_POST['id_produit'],'depot_choisi' => $_POST['depot_choisi'][$compteur] ,'quantite_depot' => $_POST['quantite_depot'][$compteur],'user' => $_SESSION['id_user'] );
    ...
    public function sortirproduit($id_produit='')
    {
        ...
        {         
            ...
            //{
                ...
                $produit_cible = $this->model->get_produit_by_id($id_produit) ; 
                $depots = $this->model->get_emplacement($id_produit) ;
                ...
                { 
                    for($compteur = 0 ; $compteur<count($_POST['depot_choisi']) ; $compteur++)
                    {
                        $arg = array('id_produit' => $_POST['id_produit'],'depot_choisi' => $_POST['depot_choisi'][$compteur] ,'quantite_depot' => $_POST['quantite_depot'][$compteur],'user' => $_SESSION['id_user'],'type_sortie' => $_POST['type_sortie'][$compteur]);
    ...
    public function consulterhistorique()
    {
        ...
        if(isset($_SESSION['id_user']) == true)
        {
            if($this->model->verifier_droit_acces(id_consulterstock, $_SESSION['id_user']) == true)
            {
                ...
                $options = array('produit_stock' => '0', 'depot_stock' => '0', 'date_stock_1' => '0', 'date_stock_2' => '0', 'user_stock' => '0' , 'type_mouvement_stock' => '0' ) ;

                if ( ( isset($_POST["valider_consulter_historique"] ) == true )  )
                { 
                    if($_POST['produit_stock']!='0' || $_POST['depot_stock']!='0' || $_POST['date_stock_1']!='0' || $_POST['date_stock_2']!='0' || $_POST['user_stock']!='0' || $_POST['type_mouvement_stock']!='0')
                    {
                        $options = $_POST ;

...
{    
    ...
    public function update_commande($arg)
    {
        ...
        $parameters = array(':id_commande' => $arg['id_commande'], ':fournisseur_commande' => $arg['fournisseur_commande'], ':produit_commande' =>  $arg['produit_commande'], ':date_commande' => $arg['date_commande'], ':quantite_commande' => $arg['quantite_commande'], ':user_commande' => $arg['user_commande'], ':etat_commande' => $arg['etat_commande']) ;
